...
This workspace already has stronger shell primitives than the first WIP:

- a declared PLAY contract seam
- richer audio shell behavior
- a pending-mutation whisper
- a saved-station shell
- a quiet runtime inspector

Preserve those gains.

Do not throw them away by rewriting toward generic player UI.
...
1. deepen invitation → immersion quality
2. make `depth` feel more bodily and premium
3. refine playing-state control clarity without clutter
4. make saved stations feel emotionally real
5. keep mutation and continuity cues subtle and trustworthy
6. keep the runtime inspector available but visually recessive
