...
function deriveExitAffinity(meta: AtomMeta): ExitTransitionId[] {
  ...
  if (meta.continuous) {
    affinities.push('dissolve', 'seal');
  } else {
    affinities.push('stamp', 'dissolve');
  }
