...
const principles: Principle[] = [
  {
    id: 0, icon: Shield, title: 'Autonomy',
    ...
    assetFamily: 'mindblock', assetVariant: 'integration', assetMode: 'light',
  },
  {
    id: 1, icon: Lock, title: 'Infrastructure',
    ...
    assetFamily: 'neuralflow', assetVariant: 'flourish', assetMode: 'light',
  },
  {
    id: 2, icon: CheckCircle2, title: 'Continuity',
    ...
    assetFamily: 'flowstate', assetVariant: 'blossoming', assetMode: 'light',
  },
];
    ...
    >
      <div className="absolute inset-0">
        {principles.map((principle, i) => (
          ...
          >
            <img src={buildAssetUrl(principle.assetFamily, principle.assetVariant, principle.assetMode)} alt="" className="w-full h-full object-cover" style={{ opacity: assetOpacity.section }} />
          </motion.div>
        ))}
      </div>
      ...
      <div className="relative w-full h-full z-10" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        >
          <div className="grid w-full gap-4 mb-12" style={{ gridTemplateColumns: isMobile ? '1fr' : 'repeat(3, 1fr)', maxWidth: isMobile ? '100%' : '1100px' }}>
              ...
              return (
                <motion.button
                  ...
                  style={{
                    ...
                    background: isActive ? frostedGlass.card.background : `${colors.neutral.gray[900]}50`,
                    ...
                    cursor: 'pointer', overflow: 'hidden', transition: 'all 0.4s ease-out', textAlign: 'left',
                  }}
                >
                  {isActive && (
                    <motion.div className="absolute inset-0" animate={{ opacity: [0.2, 0.35, 0.2] }} transition={{ duration: 2, repeat: Infinity, ease: 'easeInOut' }}
                      style={{ background: `radial-gradient(circle at center, ${principle.color}25, transparent 70%)` }}
                    />
                  )}
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              style={{
                ...
                background: `${currentPrinciple.color}10`, border: `1px solid ${currentPrinciple.color}30`,
                borderRadius: radius.lg, backdropFilter: 'blur(20px)',
                marginBottom: isMobile ? '40px' : '56px', maxWidth: isMobile ? '100%' : '600px',
              }}
            >
            ...
            {principles.map((_, idx) => (
              <motion.div
                ...
                style={{
                  ...
                  backgroundColor: activePrinciple === idx ? principles[idx].color : colors.neutral.gray[700],
