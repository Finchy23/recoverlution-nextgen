...
export const navigation = {
  ...
  links: [
    ...
    { href: '/command-center', label: 'Studio' },
  ] as NavLink[],
  startButton: {
    label: 'Start',
  },
...
export const operatingTruthFeatures: OperatingTruthFeature[] = [
  { id: 1, shortName: 'JOURNEYS', icon: Calendar, layer: 'The Baseline Layer', name: 'Journeys', label: 'Your weekly rhythm', promise: 'The story shifts as behaviour repeats.', whyItMatters: 'Consistency is how defaults change.', subFeatures: [{ name: 'A weekly chapter', description: 'One focus to install.' }, { name: 'Guided experiences', description: 'You feel. You recognise.' }, { name: 'A cadence', description: 'A rhythm you can trust.' }, { name: 'Insight roots', description: 'Proven in the wild.' }, { name: 'A change', description: 'One small adjustment.' }, { name: 'Baseline, updated.', description: 'Mindblock calibrated.' }], accentColor: colors.accent.blue.primary, backgroundAsset: { collection: 'evolvingforms', name: 'skypattern', variant: 'light' } },
  { id: 2, shortName: 'CUES', icon: Compass, layer: 'The Moment Layer', name: 'NaviCues', label: 'Your momentum', promise: 'Tiny experiences. Real conditions.', whyItMatters: 'Small completions rewire faster than big plans.', subFeatures: [{ name: 'Sparks', description: 'Quick cognitive shifts' }, { name: 'Bridges', description: 'Pattern-to-choice transitions' }, { name: 'Scans', description: 'Body-first resets' }, { name: 'Threads', description: 'Values and meaning prompts' }, { name: 'Mirrors', description: 'Statement reflection' }, { name: 'Keys', description: 'Paradox and perspective unlocks' }, { name: 'Stamps', description: 'Proof markers' }], accentColor: colors.status.amber.bright, backgroundAsset: { collection: 'mindblock', name: 'integration', variant: 'light' } },
  { id: 3, shortName: 'SENSE', icon: Activity, layer: 'The Signals Layer', name: 'Sense Check', label: 'Three Signals', promise: 'The system maps to you.', whyItMatters: "The right step depends on what's available.", subFeatures: [{ name: 'Energy', description: 'What you have' }, { name: 'Clarity', description: 'What you see' }, { name: 'Anchorage', description: 'What holds you' }], accentColor: colors.accent.cyan.primary, backgroundAsset: { collection: 'neuralflower', name: 'blossom', variant: 'light' } },
  { id: 4, shortName: 'STUDIO', icon: Heart, layer: 'The Body Layer', name: 'Wellbeing Studio', label: 'Regulation First', promise: 'Find your flow.', whyItMatters: 'The nervous system sets the ceiling.', subFeatures: [{ name: 'Guided Sessions', description: 'Deliberate series, not a content dump' }, { name: 'Your Rhythm', description: 'Schedule what steadies you' }, { name: 'Foundations', description: 'Breath, movement, stillness, nourishment' }], accentColor: colors.status.green.mid, backgroundAsset: { collection: 'evolvingforms', name: 'transition', variant: 'light' } },
  { id: 5, shortName: 'TOOLKIT', icon: Package, layer: 'The Meaning Layer', name: 'Toolkit', label: 'Depth on Demand', promise: 'Context you can carry.', whyItMatters: 'Meaning lands when capacity is there.', subFeatures: [{ name: 'Articles', description: 'The calm line' }, { name: 'Insights', description: 'The deeper why' }, { name: 'Practices', description: 'Standalone components' }, { name: 'Bag', description: 'Keep what becomes yours' }], accentColor: colors.accent.cyan.light, backgroundAsset: { collection: 'mindblock', name: 'microspheres+defusion', variant: 'light' } },
  { id: 6, shortName: 'PLAY', icon: Music, layer: 'The Story Layer', name: 'Play', label: 'change the narrative', promise: 'The soundtrack to your recovery.', whyItMatters: 'Identity installation. Not ideology.', subFeatures: [{ name: 'Your Story', description: 'You download. We Play.' }, { name: 'Library', description: 'Curated spiritual soundbites' }, { name: 'Sparks', description: 'Power affirmations' }, { name: 'Flames', description: 'Contextual depth' }, { name: 'Embers', description: 'Therapeutic flow' }, { name: 'Beat Mode', description: 'Raw or tuned to the moment' }], accentColor: colors.status.amber.mid, backgroundAsset: { collection: 'evolvingforms', name: 'balance', variant: 'dark' } },
  { id: 7, shortName: 'NAVIGATE', icon: Navigation, layer: 'The Direction Layer', name: 'Navigate', label: 'course correction', promise: 'Your map updates as you change.', whyItMatters: "Recovery isn't linear. Your system shouldn't pretend it is.", subFeatures: [{ name: 'Journey Map', description: 'See where you are' }, { name: 'Pattern Tracker', description: 'What repeats, what shifts' }, { name: 'Momentum View', description: 'Feel the progress' }, { name: 'Pivot Points', description: 'When to adjust' }], accentColor: colors.brand.purple.light, backgroundAsset: { collection: 'mindblock', name: 'skyline', variant: 'light' } },
  { id: 8, shortName: 'INSIGHTS', icon: TrendingUp, layer: 'The Pattern Layer', name: 'Insights', label: 'earned understanding', promise: 'Data becomes wisdom. Patterns become proof.', whyItMatters: 'You need to see it to believe it.', subFeatures: [{ name: 'Pattern Recognition', description: 'What triggers, what soothes' }, { name: 'Momentum Metrics', description: 'Progress you can feel' }, { name: 'Baseline Shifts', description: 'The default, updating' }, { name: 'Transfer Evidence', description: 'Proof in the wild' }], accentColor: colors.status.green.bright, backgroundAsset: { collection: 'flowstate', name: 'blossoming', variant: 'light' } },
  { id: 9, shortName: 'CONNECT', icon: Users, layer: 'The Social Layer', name: 'Connect', label: 'shared humanity', promise: 'Recovery is personal. But not alone.', whyItMatters: 'Belonging accelerates everything.', subFeatures: [{ name: 'Circles', description: 'Your trusted few' }, { name: 'Shared Journeys', description: 'Parallel paths' }, { name: 'Check-ins', description: 'The accountability that feels good' }, { name: 'Celebrations', description: 'Wins, witnessed' }], accentColor: colors.accent.cyan.primary, backgroundAsset: { collection: 'evolvingforms', name: 'convergence', variant: 'light' } },
  { id: 10, shortName: 'REFLECT', icon: Flame, layer: 'The Integration Layer', name: 'Reflect', label: 'consolidation', promise: 'Experience becomes wisdom.', whyItMatters: 'The system learns what your nervous system discovers.', subFeatures: [{ name: 'Weekly Review', description: 'What landed, what shifted' }, { name: 'Pattern Journal', description: 'Your evolving map' }, { name: 'Integration Prompts', description: 'Seal the learning' }, { name: 'Wisdom Archive', description: 'What becomes yours' }], accentColor: colors.status.amber.bright, backgroundAsset: { collection: 'neuralflow', name: 'flourish', variant: 'light' } },
];
...
export const alwaysRunningContent = {
  ...
  phases: [
    { id: 'target', title: 'Target', subtitle: 'We find the gap', description: 'The system identifies the moment between intent and action. The window opens.', icon: Target, color: colors.accent.cyan.primary },
    { id: 'build', title: 'Build', subtitle: 'You lay the wire', description: 'Micro-experiences create new pathways. Small completions compound into certainty.', icon: Zap, color: colors.status.amber.bright },
    { id: 'receipt', title: 'Receipt', subtitle: 'Life proves it', description: 'Real conditions test the new pattern. Evidence consolidates the change.', icon: Shield, color: colors.status.green.bright },
  ],
...
export const sentientBaselinePrinciples: SentientPrinciple[] = [
  { title: 'Decide', description: 'The system responds to what you need, not what it thinks you should want.', icon: Compass, assetFamily: 'flowstate', assetVariant: 'decide', assetMode: 'light' },
  { title: 'Flow', description: 'Change compounds when momentum feels natural, not forced.', icon: Activity, assetFamily: 'flowstate', assetVariant: 'chain+flow', assetMode: 'dark' },
  { title: 'Commit', description: "Trust builds through continuity. The system runs even when you can't.", icon: Shield, assetFamily: 'flowstate', assetVariant: 'commit', assetMode: 'light' },
];
...
export const clinicalVertebrae: Vertebra[] = [
  { id: 'core', name: 'CORE', description: 'Foundational architecture of change', layerIds: [1, 2, 3, 4, 5], color: colors.accent.blue.primary },
  { id: 'run', name: 'RUN', description: 'Active execution layer', layerIds: [6, 7, 8, 9], color: colors.status.amber.bright },
  { id: 'memory', name: 'MEMORY', description: 'Integration and proof', layerIds: [10, 11, 12, 13], color: colors.status.green.bright },
];
