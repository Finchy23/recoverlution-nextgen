 ...
 *
 * SEEK→FORM Handoff:
 *   Accepts `schemaOverride` — raw text from SEEK insight navigation.
...
export function FormSurface({
  ...
  // ─── Handoff overrides (TALK→FORM, SEEK→FORM) ───
  ...
  const advanceStep = useCallback(() => {
    ...
    if (nextIndex >= totalSteps) {
      ...
      setTimeout(() => {
        ...
        // ── FORM → ∞MAP: K.B.E. Believing nudge ──
        // Match this practice's atomId to a SEEK insight,
