 ...
 *   SEEK — Insights (tangible understanding)
 *   FORM — Practices (somatic instruments)
 *
...
export const KINDS: KindMeta[] = [
  ...
  { kind: 'insights',  word: 'SEEK', modeId: 'seek',    whisper: 'The anatomy of truth' },
  { kind: 'practices', word: 'FORM', modeId: 'form',    whisper: 'The body takes over' },
];
