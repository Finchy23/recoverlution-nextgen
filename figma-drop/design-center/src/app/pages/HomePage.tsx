...
import { ComponentOneOperatingTruthSection4 } from '@/app/pages/home-sections/OneOperatingTruthScrollytelling';
  ...
  return (
    ...
    >
      ...
      <main style={{ position: 'relative' }}> {/* Required for scroll-based components */}
        ...
        <ComponentOneOperatingTruthSection4 mounted={mounted} />
