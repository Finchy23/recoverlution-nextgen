...
const features: Feature[] = [
  {
    id: 1, shortName: 'JOURNEYS', icon: Calendar, layer: 'The Baseline Layer',
    name: 'Journeys', label: 'Your weekly rhythm',
  ...
  {
    id: 2, shortName: 'CUES', icon: Compass, layer: 'The Moment Layer',
    name: 'NaviCues', label: 'Your momentum',
  ...
  {
    id: 3, shortName: 'SENSE', icon: Activity, layer: 'The Signals Layer',
    name: 'Sense Check', label: 'Three Signals',
  ...
  {
    id: 4, shortName: 'STUDIO', icon: Heart, layer: 'The Body Layer',
    name: 'Wellbeing Studio', label: 'Regulation First',
  ...
  {
    id: 5, shortName: 'TOOLKIT', icon: Package, layer: 'The Meaning Layer',
    name: 'Toolkit', label: 'Depth on Demand',
  ...
  {
    id: 6, shortName: 'PLAY', icon: Music, layer: 'The Story Layer',
    name: 'Play', label: 'change the narrative',
  ...
  {
    id: 7, shortName: 'NAVIGATE', icon: Navigation, layer: 'The Pathway Layer',
    name: 'Navigate', label: 'Guided pathways',
  ...
  {
    id: 8, shortName: 'MOMENTUM', icon: TrendingUp, layer: 'The Progress Layer',
    name: 'Momentum', label: 'Streaks and consistency',
  ...
  return (
    <section
      ...
      style={{
        ...
        overflow: 'hidden',
        padding: isMobile ? `${spacing['3xl']} 0` : `120px 0`,
      }}
    >
      ...
      <div className="absolute inset-0">
        <img
          ...
          style={{ opacity: assetOpacity.hero }}
        />
