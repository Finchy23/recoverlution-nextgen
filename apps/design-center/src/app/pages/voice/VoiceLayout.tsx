 ...
 * VOICE LAYOUT
 * ============
 * Shell for the Voice Composition Workspace (Layer 4: Persona + Layer 7: Atomic Voice).
 * Tests all 5 voice lanes, copy libraries, 8 typographic variables.
...
const ACCENT = workspaceNavAccents.voice; // Verdant green — voice's signature
