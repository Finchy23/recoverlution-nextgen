 ...
 * ATOMS LAYOUT
 * ============
 * Shell for the Atom Composition Workspace.
 * Clean top bar with cross-navigation to other layers.
 * Wraps content in DeviceMirrorProvider for phone preview.
 */
...
const ACCENT = workspaceNavAccents.atoms;

function AtomsTopBar() {
