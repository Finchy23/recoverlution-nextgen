 ...
 * DELIVERY LAYOUT
 * ===============
 * Shell for the Delivery workspace — the content mapping page.
 * Maps atoms to their content profiles, vocal family affinities,
 * and voice slot configurations. The bridge between atoms and voice.
 *
 * Accent: amber resonance (warm, shipping, content mapping).
 * Same architectural pattern as VoiceLayout / AtomsLayout.
 */
