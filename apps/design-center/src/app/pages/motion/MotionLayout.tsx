 ...
 * MOTION LAYOUT
 * =============
 * Shell for the Motion Composition Workspace (Layer 5: Temporal Bookends).
 * Tests entrance architectures, exit transitions, materializations, motion curves.
...
const ACCENT = workspaceNavAccents.motion; // Twilight purple — motion's signature

function MotionTopBar() {
